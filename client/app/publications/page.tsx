...
export default function ResearchPage() {
  ...
  const indexedConferences: Paper[] = [
    { title: "Application of Artificial Intelligence in Education", authors: "Tumen-Ayush Munkhbayar, Ulziibayar Sonom-Ochir", year: "2025", venue: "AI enabled higher education ecosystem" },    
  ...
  const nonIndexedPapers: Paper[] = [
    { title: "Нийгмийн сүлжээнд латин үсгээр галиглагдсан текстийг стандарт хэлбэрт шилжүүлэх аргын судалгаа", authors: "Б.Золзаяа, С.Өлзийбаяр, Б.Ариунзаяа", year: "2026", venue: "ШУТИС-н эрдэм шинжилгээний бүтээлийн эмхэтгэл/№26(01)367" },
    { title: "Нөөц багатай хэлэнд шуугиантай галиглагдсан бичвэрийг хэлний том загварт суурилан хэвийн болгох судалгаа", authors: "С.Өлзийбаяр, Б.Золзаяа, Б.Ариунзаяа", year: "2026", venue: "ШУТИС-н эрдэм шинжилгээний бүтээлийн эмхэтгэл/№26(01)367" },
    { title: "Дүрс боловсруулалтад суурилсан эртний рүни-монгол бичгийг орчин цагийн монгол хэл рүү хөрвүүлэх олон үе шат бүхий аргачлалын судалгаа", authors: "С.Өлзийбаяр, Б.Золзаяа, Ю.Болдбаатар", year: "2026", venue: "ШУТИС-н эрдэм шинжилгээний бүтээлийн эмхэтгэл/№" },
    { title: "Компьютерийн хараанд суурилсан хувийн хамгаалах хэрэгслийн хяналтын системийн загварчлал, хэрэгжилт", authors: "Ж.Сумъяарагчаа, С.Өлзийбаяр", year: "2026", venue: "ММТ-2026" },
    { title: "Чичиргээнд суурилсан автомашины хөдөлгүүрийн эвдрэл илрүүлэх: domain adaptation аргаар загварыг шинэ орчинд дасан зохицуулах", authors: "З.Сарантуяа, Д.Наранбат,С.Өлзийбаяр", year: "2026", venue: "ММТ-2026" },
