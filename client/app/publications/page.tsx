...
export default function ResearchPage() {
  ...
  const nonIndexedPapers: Paper[] = [
    ...
    { title: "Домэйн дасан зохицох аргад суурилсан ухаалаг камерийн тохируулгатай хяналтын систем: Замын хөдөлгөөний аюулгүй байдалд ашиглах нь", authors: "С.Өлзийбаяр, Б.Золзаяа, Э.Мөнхсүх, А.Алтангэрэл", year: "2025", venue: "Авто тээвэр - 100 жил", note: "III байр" },
    { title: "Бага өгөгдөлтэй нөхцөлд шуугиантай галиглагдсан бичвэрийг хэвийн болгох аргын судалгаа", authors: "Б.Золзаяа, С.Өлзийбаяр, А.Алтангэрэл, Э.Мөнхсүх", year: "2025", venue: "Эрдмийн чуулган-2025", note: "III байр" },
    { title: "Дүрсийн боловсруулалтад суурилсан жолоочийн анхаарал сарнилтыг илрүүлэх ухаалаг систем", authors: "С.Өлзийбаяр, Б.Золзаяа, А.Алтангэрэл", year: "2024", venue: "Барилга замын машин төхөөрөмж мэргэжлийн 60 жилийн ой", note: "II байр" },
    ...
    { title: "Дроныг хүргэлтийн үйлчилгээнд ашиглах боломжийн судалгаа", authors: "Б.Амаржаргал, С.Өлзийбаяр", year: "2025", venue: "Г.Цогбадрахын нэрэмжит магистр, доктор оюутны ЭШХ", note: "I байр" },
    { title: "Хиймэл оюун ухаанд суурилсан жолоочийн аюулгүй байдлыг хянах системийн судалгаа ба хөгжүүлэлт", authors: "Б.Амартүвшин, Н.Гантөмөр, Б.Золзаяа", year: "2025", venue: "Эрдмийн чуулган", note: "I байр" },
    { title: "SafeKid AI: Хиймэл оюунд суурилсан хүүхэд хяналтын систем", authors: "О.Оюунжаргал, С.Азжаргал, Б.Золзаяа", year: "2025", venue: "Эрдмийн чуулган", note: "II байр" },
    ...
    { title: "Ухаалаг хөтөч v2.0", authors: "М.Түмэн-Аюуш, Ч.Мичидгоо, С.Батмөнх, С.Өлзийбаяр", year: "2024", venue: "ШУТИС 65 жилийн ой", note: "III байр" },
    { title: "Дүрсийн боловсруулалтад суурилсан ухаалаг хог ангилагч", authors: "А.Цолмонбаяр, Б.Болоржин, Б.Энхзул, Б.Золзаяа", year: "2024", venue: "ШУТИС 65 жилийн ой", note: "I байр" },
    ...
    { title: "Сэдвийн загварчлал ашиглан текст өгөгдөлд шинжилгээ хийх", authors: "С.Болор-Эрдэнэ, З.Эгшиглэн, С.Өсөхбаяр, Б.Золзаяа", year: "2024", venue: "Г.Цогбадрахын нэрэмжит бакалавр оюутны ЭШХ", note: "I байр" },
  ];
  ...
  const achievements: Project[] = [
    { title: "MissingAlert: хиймэл оюунд суурилсан хяналтын систем.", authors: "С.Азжаргал, О.Оюунжаргал, Б.Золзаяа", year: "2026", venue: "ШУТИС-ийн оюутны шилдэг өгүүлэл шалгаруулах хурал", note: "I байр" },
    { title: "Цээжний рентген зурагт суурилсан оношилгооны тайлан үүсгэх AI загварын судалгаа.", authors: "М.Энхболор, Б.Золзаяа", year: "2026", venue: "Доктор (Ph.D.), профессор Г. Цогбадрахын нэрэмжит МХТС-ийн бакалавр оюутны Мэдээлэл Холбооны салбарын хөгжилд бидний гүйцэтгэх үүрэг сэдэвт 2025-2026 оны хичээлийн жилийн хаврын улирлын эрдэм шинжилгээний хурал", note: "I байр" },
    { title: "MissingAlert: хиймэл оюунд суурилсан хяналтын систем.", authors: "С.Азжаргал, О.Оюунжаргал, Б.Золзаяа", year: "2026", venue: "Доктор (Ph.D.), профессор Г. Цогбадрахын нэрэмжит МХТС-ийн бакалавр оюутны Мэдээлэл Холбооны салбарын хөгжилд бидний гүйцэтгэх үүрэг сэдэвт 2025-2026 оны хичээлийн жилийн хаврын улирлын эрдэм шинжилгээний хурал", note: "II байр" },
    ...
    { title: "Хиймэл оюун ухаанд суурилсан жолоочийн аюулгүй байдлыг хянах системийн судалгаа ба хөгжүүлэлт.", authors: "Б.Амартүвшин, Н.Гантөмөр, Б.Золзаяа", year: "2025", venue: "Эрдмийн чуулган эрдэм шинжилгээний хурал", note: "I байр" },
    { title: "SafeKid AI: Хиймэл оюунд суурилсан хүүхэд хяналтын систем.", authors: "О.Оюунжаргал, С.Азжаргал, Б.Золзаяа", year: "2025", venue: "Эрдмийн чуулган эрдэм шинжилгээний хурал", note: "II байр" },
    ...
    { title: "SafeKid AI: Хиймэл оюунд суурилсан хүүхэд хяналтын систем.", authors: "О.Оюунжаргал, С.Азжаргал, Б.Золзаяа", year: "2025", venue: "Мэдээлэл Холбооны салбарын хөгжилд бидний гүйцэтгэх үүрэг сэдэвт 2025-2026 оны хичээлийн жилийн намрын улирлын эрдэм шинжилгээний хурал", note: "II байр" },
