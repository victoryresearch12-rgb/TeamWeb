...
export const professors: Professor[] = [
  {
    ...
    education: [
      ...
      {
        degree: 'Магистр, Компьютерийн инженерчлэл',
        institution: 'Улсын Их Сургууль',
        year: '2015'
      }
    ],
  ...
  },
  {
    ...
    title: 'Дэд профессор — Текст ба Эх хэлний боловсруулалт',
    img: '/images/professors/zolzaya.png',
    email: 'zolzaya@must.edu.mn',
    phone: '+976 9999-9999',
    office: 'Лаборатори 303',
    ...
    education: [
      {
        degree: 'Ph.D компьютерийн шинжлэх ухаан',
        institution: 'Солонгосын Их Сургууль (KAIST)',
        year: '2021'
      },
      {
        degree: 'Магистр, Мэдээлэл зүйн систем',
        institution: 'Улсын Их Сургууль',
        year: '2016'
      }
    ],
